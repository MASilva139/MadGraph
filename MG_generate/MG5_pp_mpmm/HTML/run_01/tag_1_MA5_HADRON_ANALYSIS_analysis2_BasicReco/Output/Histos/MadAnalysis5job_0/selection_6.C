void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,0.07670458474089366);
  S7_ETA_0->SetBinContent(17,0.08188380614372352);
  S7_ETA_0->SetBinContent(18,0.10185249541048434);
  S7_ETA_0->SetBinContent(19,0.11264188309443378);
  S7_ETA_0->SetBinContent(20,0.12057573731236251);
  S7_ETA_0->SetBinContent(21,0.11913866880059532);
  S7_ETA_0->SetBinContent(22,0.1151389940250148);
  S7_ETA_0->SetBinContent(23,0.1081371194801094);
  S7_ETA_0->SetBinContent(24,0.08825261919396145);
  S7_ETA_0->SetBinContent(25,0.07567409179842122);
