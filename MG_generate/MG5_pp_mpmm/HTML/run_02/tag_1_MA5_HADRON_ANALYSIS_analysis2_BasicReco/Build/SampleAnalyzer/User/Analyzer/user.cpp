...
MAbool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("9_PT", _P_mu_I1I_PTorderingfinalstate_REG_[ind[0]]->pt());
    }
  }
  }
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_mu_I1I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
      Manager()->FillHisto("10_ETA", _P_mu_I1I_PTorderingfinalstate_REG_[ind[0]]->eta());
    }
  }
  }
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_mu_I1I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
      Manager()->FillHisto("11_MT_MET", _P_mu_I1I_PTorderingfinalstate_REG_[ind[0]]->mt_met(event.mc()->MET().momentum()));
    }
  }
  }
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("12_PT", _P_mu_I2I_PTorderingfinalstate_REG_[ind[0]]->pt());
    }
  }
  }
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_mu_I2I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
      Manager()->FillHisto("13_ETA", _P_mu_I2I_PTorderingfinalstate_REG_[ind[0]]->eta());
    }
  }
  }
  ...
  {
  {
    ...
    for (ind[0]=0;ind[0]<_P_mu_I2I_PTorderingfinalstate_REG_.size();ind[0]++)
    {
      Manager()->FillHisto("14_MT_MET", _P_mu_I2I_PTorderingfinalstate_REG_[ind[0]]->mt_met(event.mc()->MET().momentum()));
    }
  }
  }
  ...
  {
  {
    ...
    for (b[0]=0;b[0]<_P_j_I2I_PTorderingfinalstate_REG_.size();b[0]++)
    {
     if ( _P_j_I1I_PTorderingfinalstate_REG_[a[0]] == _P_j_I2I_PTorderingfinalstate_REG_[b[0]] ) continue;
      Manager()->FillHisto("21_DELTAR", _P_j_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_j_I2I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("22_DELTAR", _P_j_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_mu_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    {
      Manager()->FillHisto("23_DELTAR", _P_j_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_mu_I2I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    for (b[0]=0;b[0]<_P_mu_I1I_PTorderingfinalstate_REG_.size();b[0]++)
    {
      Manager()->FillHisto("24_DELTAR", _P_j_I2I_PTorderingfinalstate_REG_[a[0]]->dr(_P_mu_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    for (b[0]=0;b[0]<_P_mu_I2I_PTorderingfinalstate_REG_.size();b[0]++)
    {
      Manager()->FillHisto("25_DELTAR", _P_j_I2I_PTorderingfinalstate_REG_[a[0]]->dr(_P_mu_I2I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
  ...
  {
  {
    ...
    for (b[0]=0;b[0]<_P_mu_I2I_PTorderingfinalstate_REG_.size();b[0]++)
    {
     if ( _P_mu_I1I_PTorderingfinalstate_REG_[a[0]] == _P_mu_I2I_PTorderingfinalstate_REG_[b[0]] ) continue;
      Manager()->FillHisto("26_DELTAR", _P_mu_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_mu_I2I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
