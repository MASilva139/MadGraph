void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,0.07484647336804336);
  S7_ETA_0->SetBinContent(17,0.09123334991892061);
  S7_ETA_0->SetBinContent(18,0.10086824265818034);
  S7_ETA_0->SetBinContent(19,0.10822354061266104);
  S7_ETA_0->SetBinContent(20,0.11501913592870747);
  S7_ETA_0->SetBinContent(21,0.1296531029796634);
  S7_ETA_0->SetBinContent(22,0.11781735664432155);
  S7_ETA_0->SetBinContent(23,0.1002582015544999);
  S7_ETA_0->SetBinContent(24,0.08539740268468131);
  S7_ETA_0->SetBinContent(25,0.07668319365032095);
