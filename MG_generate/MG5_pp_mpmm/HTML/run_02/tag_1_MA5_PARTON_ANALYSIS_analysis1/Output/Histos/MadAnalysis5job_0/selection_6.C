void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,627775.9);
  S7_ETA_0->SetBinContent(17,766738.9);
  S7_ETA_0->SetBinContent(18,872603.4);
  S7_ETA_0->SetBinContent(19,946211.7000000001);
  S7_ETA_0->SetBinContent(20,987563.7000000001);
  S7_ETA_0->SetBinContent(21,998933.4);
  S7_ETA_0->SetBinContent(22,949412.1000000001);
  S7_ETA_0->SetBinContent(23,889615.9);
  S7_ETA_0->SetBinContent(24,766486.2000000001);
  S7_ETA_0->SetBinContent(25,616658.8);
