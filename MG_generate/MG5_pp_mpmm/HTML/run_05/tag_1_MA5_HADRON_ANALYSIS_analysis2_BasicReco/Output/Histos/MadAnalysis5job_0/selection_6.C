void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,0.06892466882209328);
  S7_ETA_0->SetBinContent(17,0.08964858021556668);
  S7_ETA_0->SetBinContent(18,0.13177331966496791);
  S7_ETA_0->SetBinContent(19,0.10263125731782252);
  S7_ETA_0->SetBinContent(20,0.11820199350568614);
  S7_ETA_0->SetBinContent(21,0.11606647945779756);
  S7_ETA_0->SetBinContent(22,0.12062713770007615);
  S7_ETA_0->SetBinContent(23,0.10755060601661752);
  S7_ETA_0->SetBinContent(24,0.08742479856224965);
  S7_ETA_0->SetBinContent(25,0.05715115873712264);
