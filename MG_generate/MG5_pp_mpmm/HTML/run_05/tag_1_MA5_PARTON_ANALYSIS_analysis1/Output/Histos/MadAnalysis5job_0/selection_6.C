void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,601248.3572800033);
  S7_ETA_0->SetBinContent(17,778582.8446800042);
  S7_ETA_0->SetBinContent(18,860494.538860001);
  S7_ETA_0->SetBinContent(19,947472.832680005);
  S7_ETA_0->SetBinContent(20,1012495.9280599734);
  S7_ETA_0->SetBinContent(21,994762.0293200052);
  S7_ETA_0->SetBinContent(22,936495.0334600013);
  S7_ETA_0->SetBinContent(23,890050.2367600048);
  S7_ETA_0->SetBinContent(24,771827.2451600041);
  S7_ETA_0->SetBinContent(25,651070.9537399999);
